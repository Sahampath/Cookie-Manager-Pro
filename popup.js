...
const translations = {
    ...
    si: {
        ...
        siteCookieCountLabel: 'වෙබ් අඩවි කුකීස්:',
        getSiteBtnText: 'වෙබ් අඩවි කුකීස් නැවත ලබා ගන්න',
        exportSiteBtnText: 'වෙබ් අඩවි කුකීස් නිර්යාත කරන්න',
        importSiteBtnText: 'වෙබ් අඩවි කුකීස් ආයාත කරන්න',
        clearSiteBtnText: 'වෙබ් අඩවි කුකීස් මකන්න',
        exportAllBtnText: 'සියලු කුකීස් නිර්යාත කරන්න',
        importAllBtnText: 'සියලු කුකීස් ආයාත කරන්න',
        manualJsonBtnText: 'JSON අතින් එකතු කරන්න',
        cookiesListTitle: 'වත්මන් වෙබ් අඩවියේ කුකීස්:',
        exportSuccess: '✓ කුකීස් සාර්ථකව නිර්යාත කරන ලදි!',
        exportError: '✗ කුකීස් නිර්යාත කිරීම අසාර්ථකයි',
        importConfirm: '⚠️ ආයාත කිරීම සියලුම පවතින කුකීස් ප්‍රතිස්ථාපනය කරයි. කරුණාකර තහවුරු කරන්න?',
        importSiteConfirm: '⚠️ ආයාත කිරීම මෙම වෙබ් අඩවියේ සියලුම කුකීස් ප්‍රතිස්ථාපනය කරයි. කරුණාකර තහවුරු කරන්න?',
        clearSiteConfirm: '⚠️ මෙම වෙබ් අඩවියේ සියලුම කුකීස් ස්ථිරවම මැකේ. කරුණාකර තහවුරු කරන්න?',
        importSuccess: '✓ කුකීස් සාර්ථකව ආයාත කරන ලදි! කුකීස් {count} ක් ප්‍රතිස්ථාපනය විය.',
        importSiteSuccess: '✓ වෙබ් අඩවි කුකීස් සාර්ථකව ආයාත කරන ලදි! කුකීස් {count} ක් ප්‍රතිස්ථාපනය විය.',
        clearSiteSuccess: '✓ මෙම වෙබ් අඩවියේ සියලුම කුකීස් මකා දමන ලදි.',
        importError: '✗ කුකීස් ආයාත කිරීම අසාර්ථකයි',
        invalidJSON: '✗ අවලංගු JSON ගොනු ආකෘතිය',
        invalidJsonFormat: '✗ අවලංගු JSON ආකෘතිය. කුකී වස්තු පෙළක් අපේක්ෂා කෙරේ.',
        manualImportSuccess: '✓ අතින් JSON වෙතින් කුකීස් {count} සාර්ථකව ආයාත කරන ලදි.',
        manualJsonTitle: 'කුකී JSON පෙළ අලවන්න:',
        manualImportSiteText: 'වෙබ් අඩවි කුකීස් ලෙස ආයාත කරන්න',
        manualImportAllText: 'සියලු කුකීස් ලෙස ආයාත කරන්න',
        manualCancelText: 'අවලංගු කරන්න',
        loading: 'පූරණය වෙමින්...',
        processing: 'සැකසෙමින්...',
        noCookies: 'මෙම වෙබ් අඩවිය සඳහා කුකීස් හමු නොවීය',
        siteCookiesLoaded: 'වත්මන් වෙබ් අඩවිය සඳහා කුකීස් {count} ක් පූරණය කරන ලදි',
